            ...
            <div class="col-12 my-2 px-2">
                <div class="row">
                    <div class="col-1 bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-danger">User ID</span>
                        </div>
                    </div>

                    <div class="col-6 col-md-5 bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-light">User Name</span>
                        </div>
                    </div>

                    <div class="col-md-3 col-5  bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-light">Email</span>
                        </div>
                    </div>

                    <div class="d-none col-md-1 d-md-block bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-danger">Seller Access</span>
                        </div>
                    </div>

                    <div class="d-none col-md-1 d-md-block bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-danger">User Access</span>
                        </div>
                    </div>

                    <div class="d-none col-md-1 d-md-block bg-dark">
                        <div class="row">
                            <span class="fw-bold text-center p-1 text-danger">User status</span>
                        </div>
                    </div>
                </div>
            </div>
